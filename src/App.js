              ...
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  ...
                  <p>
                    ...
                    pain bio &amp; confiture, 1 viennoiserie bio au choix,
          ...
          <div className="MenuItems--items">
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  ...
                  <p>
                    Assortiment de pains bio, beurre &amp; confitures bio + 1
                    viennoiserie bio au choix + 1 boisson fraîche au choix
                  </p>
                  <div className="MenuItem--infos">
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  <h3>Chia bowl</h3>
                  <p>Graines de chia bio, myrtilles, grenades, crunola bio</p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
                    <span className="MenuItem--popular">
                      <svg
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  ...
                  <p>
                    Muesli maison bio, boisson à l’amande bio, fruits de saison
                    et super graines bio (VEGAN)
                  </p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
                  </div>
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  <h3>César BLT</h3>
                  <p>
                    Poulet, parmesan, avocat, croûtons, bacon, chips de légumes,
                    jeunes pousses, kale et tomates cerises
                  </p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
                    <span className="MenuItem--popular">
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  <h3>Buddha bowl</h3>
                  <p>
                    Saumon fumé, avocat, super graines bio, lentilles au parika,
                    chou rouge, concombre, jeunes pousses
                  </p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
                  </div>
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  <h3>Veggie Bowl</h3>
                  <p>
                    Sarrasin bio, quinoa bio, houmous de carottes, lentilles au
                    paprika, courge butternut, grenade, avocat, caviar d'algues,
                    chips de légumes bio
                  </p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
                  </div>
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  ...
                  <p>Lentilles au paprika, carottes bio et oeuf poché bio</p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">3,00 €</span>
                  </div>
                </div>
        ...
        <div className="MenuItems">
          ...
          <div className="MenuItems--items">
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  ...
                  <p>
                    Demi-tartine du jour &amp; soupe du jour aux légumes bio,
                    servi avec du pain bio et une salade de jeunes pousses bio
                  </p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
                  </div>
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  <h3>Pot-au-feu de légumes bio, curry bio et poulet grillé</h3>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
                  </div>
                </div>
            ...
            <div className="MenuItem">
              <div className="MenuItem--card">
                <div className="MenuItem--texts">
                  ...
                  <p>
                    Servi avec sarrasin bio et chutney de cassis au gingembre
                    (VEGAN)
                  </p>
                  <div className="MenuItem--infos">
                    <span className="MenuItem--price">6,00 €</span>
